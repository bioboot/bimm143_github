...
> Q. Create a custom view of HIV-Pr highlighting the active site ASP rsidues (`resno=25`), the two chains (in your choice of colors), and the ligand all on a custom color background?
...
Let's do a Normal Mode Analysis (NMA) to predict the flexiblity of a give `pdb` object:
