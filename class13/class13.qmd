...
We need to chack that the metadata matches the samples in our count data.
...
- Step 1. Find which columns in `counts` correspond to to "control" samples.
...
> Q. Use ggolot to make a first version "volcano plot" of `log2FoldChange` vs `padj`
