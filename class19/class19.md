...
smaple of it’s type every assembled.
...
informations about a given Ab measurment
...
> Q. HOw many Ab measurments do we have in total
...
individuals. Levels peak at day 14 and are larger in magnitute for wP
than aP individuals.

There are lots of cool things to explore in this dataset and we need
coding and biology knoweledge to do it effectively - i.e. you gus!!!

``` r
igg |> filter(visit %in% 1:10) |>
ggplot() +
  aes(MFI_normalised, antigen) +
  geom_boxplot() + 
    xlim(0,75) +
