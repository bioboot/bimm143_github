...
Let's compare "base" and **ggplot2** briefly. We canuse some example data that is built-in with R called `cars`:
...
For "simple" plots ggplot is much more verbose than base R but the defults are nicer and for complicated plots it becomes much more efficent and structured.
