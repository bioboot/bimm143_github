...
ggplot(genes) +
  ...
  labs(x="No drug", y="Drug", 
       title="Expresion changes upon GLP-1 inhibitor treatment")
```
...
> Q. Make a boxplot of lifeExp colored by continent and faceted by year
